...
For core commands (daily workflow), see [COMMANDS-CORE.md](COMMANDS-CORE.md)
...
- Use `/security scan` (see COMMANDS-CORE.md) for vulnerability checks
...
- **Performance Baselines:** Configured via [docs/config/performance-baseline.md](docs/config/performance-baseline.md)
- **Ethics Validation:** Configured via [docs/config/ethics-validation.md](docs/config/ethics-validation.md)

---

## When to Load This File

**Load COMMANDS-ADVANCED.md when:**
...
**Skip loading if:**
- In Phase 1-3 (use COMMANDS-CORE.md only)
- Project doesn't require advanced analytics
- Simple projects without compliance requirements

---

**Full documentation:** See [COMMANDS-CORE.md](COMMANDS-CORE.md), [COMMANDS-ADVANCED.md](COMMANDS-ADVANCED.md) (this file), and [docs/config/mcp-tools.md](docs/config/mcp-tools.md)
