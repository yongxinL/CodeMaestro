...
- ✅ `.CodeMaestro/config/roles/` - Role files 
- ✅ `.CodeMaestro/prompts/` - Prompt and template files
...
- Files: `.CodeMaestro/prompts/` (modular phase prompts + templates)
...
#### Prompt Files in `.CodeMaestro/prompts/` (for Claude Code):
...
#### Required Configuration Files in `.CodeMaestro/config/`:
- `git-commands.md` - Git command templates
- `constraints-reference.md` - Full constraint list

#### Required Role Files in `.CodeMaestro/config/roles/`:
...
Override in `.CodeMaestro/config/thresholds.md` if needed.
...
- Ensure all prompt files are in `.CodeMaestro/prompts/`
...
- Ensure `.CodeMaestro/config/git-commands.md` exists
...
- Review phase-specific prompts in `.CodeMaestro/prompts/`
- Consult Knowledge Base: `.CodeMaestro/knowledge-base/`
