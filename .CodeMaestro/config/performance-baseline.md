...
```yaml
# .CodeMaestro/config/performance-test-config.yaml
...
Edit `.CodeMaestro/config/performance-thresholds.yaml`:
...
- [.CodeMaestro/config/performance-test-config.yaml](performance-test-config.yaml) - Test configuration
- [.CodeMaestro/config/quality-gates.md](quality-gates.md) - Quality gate integration (E32)
