...
For advanced analytics and compliance commands, see [COMMANDS-ADVANCED.md](COMMANDS-ADVANCED.md)
...
**Full documentation:** See [COMMANDS-CORE.md](COMMANDS-CORE.md) (this file), [COMMANDS-ADVANCED.md](COMMANDS-ADVANCED.md), and [docs/config/mcp-tools.md](docs/config/mcp-tools.md)
