...
1. **Check for override:** `docs/config/templates/[template-name]-override.md`
2. **Fallback to default:** `docs/prompts/[phase]-templates.md`
...
# 1. Find the template section in docs/prompts/01-requirement-templates.md
...
Create a new file in `docs/config/templates/` with the `-override.md` suffix:

```bash
touch docs/config/templates/specification-override.md
```
...
**Template Location:** `docs/config/templates/mobile/`
...
**Template Location:** `docs/config/templates/web/`
...
**Template Location:** `docs/config/templates/cloud/`
...
**Template Location:** `docs/config/templates/ai/`
...
✅ Found: docs/config/templates/specification-override.md
...
1. Check if override exists: `ls docs/config/templates/*-override.md`
2. If exists, use override template
3. If not, use default from `docs/prompts/[phase]-templates.md`
...
# Copy to new project
cp .codemaestro-templates/* /path/to/project/docs/config/templates/
```
...
2. Verify file is in `docs/config/templates/`
...
```bash
docs/config/templates/examples/
├── mobile/
│   ├── specification-override.md
│   ├── blueprint-override.md
│   └── evidence-override.md
...
**To use:**
```bash
cp docs/config/templates/examples/mobile/* docs/config/templates/
```
...
2. Check examples in `docs/config/templates/examples/`
3. Consult default templates in `docs/prompts/`
