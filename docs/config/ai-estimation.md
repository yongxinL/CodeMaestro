...
Learning Applied:
  ...
  ✅ Saved to knowledge base: docs/knowledge-base/patterns/P-EST-001.md
...
```markdown
<!-- docs/knowledge-base/patterns/P-EST-001-authentication-tasks.md -->
...
```markdown
<!-- docs/knowledge-base/patterns/P-EST-[ID]-[category].md -->
...
Configure in `docs/config/estimation-config.md`:
...
- [docs/knowledge-base/](../knowledge-base/) - Estimation patterns storage
