...
Edit `docs/config/ethics-validation-config.yaml`:
...
- [docs/config/roles/ethics-security-engineer.md](../config/roles/ethics-security-engineer.md) - Role definition
- [docs/config/constraints-reference.md](../config/constraints-reference.md) - Related constraints
