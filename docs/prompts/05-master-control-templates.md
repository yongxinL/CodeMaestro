...
**Patterns Added:**
- P-[ID]: [Pattern name] → `docs/knowledge-base/patterns/`

**Failures Documented:**
- F-[ID]: [Failure name] → `docs/knowledge-base/failures/`
...
**Location:** `docs/knowledge-base/failures/F[ID]-[short-name].md`
...
1. **P-[ID]: [Pattern Name]**
   ...
   - **Location:** `docs/knowledge-base/patterns/P[ID]-[name].md`
...
1. **F-[ID]: [Failure Name]**
   ...
   - **Location:** `docs/knowledge-base/failures/F[ID]-[name].md`
